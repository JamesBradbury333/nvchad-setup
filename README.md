...
Copied from https://github.com/ProgrammingRainbow/NvChad-2.5# 
Installing NvChad on ubuntu is slightly different but all config/.lua files are the same.
...
```
git clone git@github.com:JamesBradbury333/nvchad-setup.git ~/.config/nvim && nvim
```
